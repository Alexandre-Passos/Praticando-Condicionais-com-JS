/*
Você está criando um sistema de verificação de status de pagamento de clientes. Dependendo do status, o sistema deve 
...
const verificarPagamentos = 'aprovado'
switch (verificarPagamentos) {
    case "pendente":
